...
class ChartTopItemTable extends Component
{
    public $code = '';
    public $name = '';
    public $status = '';
    ...
    public function render()
    {
        ...
        $topInItem = $data->sortByDesc('total_in')->take(3);
        ...
        $this->dispatch('chart-top-in-updated', [
            'labels' => $labels,
            'totalInValues' => $totalInValues,
        ]);

        return view('livewire.chart-top-item-table', compact(
            'labels',
            'totalInValues',
        ));
    }
