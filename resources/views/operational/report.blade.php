...
@section('content')
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="tab-pane fade show active" id="pills-pdf" role="tabpanel" aria-labelledby="pills-pdf-tab"
                        ...
                        <form id="formEdit" action="{{ route('reports.pdf', 'operationals') }}" method="POST">
                            @csrf
                            <div class="row">
    ...
    <script>
        ...
        function updateExcelLink() {
            ...
            let url =
                `{{ route('reports.excel', ['fromDate' => ':fromDate', 'toDate' => ':toDate', 'division' => 'operationals']) }}`;
            url = url.replace(':fromDate', fromDate).replace(':toDate', toDate).replace(':division', 'operationals');
            console.log(url);
