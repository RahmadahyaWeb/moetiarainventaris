...
@section('content')
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="tab-pane fade show active" id="pills-pdf" role="tabpanel" aria-labelledby="pills-pdf-tab"
                        ...
                        <form id="formEdit" action="{{ route('reports.pdf', 'bakeries') }}" method="POST">
                            @csrf
                            <div class="row">
    ...
    <script>
        ...
        function updateExcelLink() {
            ...
            let url =
                `{{ route('reports.excel', ['fromDate' => ':fromDate', 'toDate' => ':toDate', 'division' => 'bakeries']) }}`;
            url = url.replace(':fromDate', fromDate).replace(':toDate', toDate).replace(':division', 'bakeries');
            console.log(url);
